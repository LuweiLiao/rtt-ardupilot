...
#define LOG_STRUCTURE_FROM_BOARD_HAL LOG_STRUCTURE_FROM_HAL_CHIBIOS
#define LOG_IDS_FROM_BOARD_HAL LOG_IDS_FROM_HAL_CHIBIOS
#elif CONFIG_HAL_BOARD == HAL_BOARD_RTT
#include <AP_HAL_RTT/LogStructure.h>
#define LOG_STRUCTURE_FROM_BOARD_HAL LOG_STRUCTURE_FROM_HAL_RTT
#define LOG_IDS_FROM_BOARD_HAL LOG_IDS_FROM_HAL_RTT
#else
#define LOG_STRUCTURE_FROM_BOARD_HAL
#define LOG_IDS_FROM_BOARD_HAL
#endif
