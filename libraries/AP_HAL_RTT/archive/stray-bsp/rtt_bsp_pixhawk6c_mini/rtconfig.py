...
# EXEC_PATH is the compiler execute path. Use RTT_EXEC_PATH env or same default as fmuv2.
if  CROSS_TOOL == 'gcc':
    PLATFORM    = 'gcc'
    EXEC_PATH   = os.getenv('RTT_EXEC_PATH') or (r'/opt/gcc-arm-none-eabi-10-2020-q4-major/bin' if os.name != 'nt' else r'C:\Users\XXYYZZ')
