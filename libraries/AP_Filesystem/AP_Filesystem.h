...
#if (CONFIG_HAL_BOARD == HAL_BOARD_CHIBIOS) || (CONFIG_HAL_BOARD == HAL_BOARD_ESP32) || (defined(HAL_BOARD_RTT) && CONFIG_HAL_BOARD == HAL_BOARD_RTT && !AP_FILESYSTEM_POSIX_ENABLED)
#define DT_REG 0
#define DT_DIR 1
#define DT_LNK 10
#endif

#if CONFIG_HAL_BOARD == HAL_BOARD_CHIBIOS || (defined(HAL_BOARD_RTT) && CONFIG_HAL_BOARD == HAL_BOARD_RTT && !AP_FILESYSTEM_POSIX_ENABLED)
...
#if CONFIG_HAL_BOARD == HAL_BOARD_LINUX || CONFIG_HAL_BOARD == HAL_BOARD_SITL || CONFIG_HAL_BOARD == HAL_BOARD_QURT || (defined(HAL_BOARD_RTT) && CONFIG_HAL_BOARD == HAL_BOARD_RTT && AP_FILESYSTEM_POSIX_ENABLED)
