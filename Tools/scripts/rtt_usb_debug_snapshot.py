...
SYMBOLS = (
    ...
    "rtt_dbg_cherry_dtr_closed_last_diepctl",
    "rtt_dbg_cherry_dtr_closed_last_diepint",
    "rtt_dbg_cherry_dtr_closed_last_dieptsiz",
    "rtt_dbg_cherry_dtr_closed_last_dtxfsts",
